...
<!--- Title --->
<h2><img src="includes/images/vcard.png" align="absmiddle"> Role Management : Edit Role</h2>
...
<form name="roleForm" id="roleForm" action="#event.buildlink(rc.xehUpdate & '/roleID/' & rc.roleID)#">
	...
	<input type="text" name="role" id="role" dName="Role" size="30" value="#rc.oRole.getRole()#" 
		   required="true">
	
	<label for="lname">Description</label>
	<label class="helptext">A brief role description.</label>
	<textarea name="description" id="description" dName="Description" required="true">#rc.oRole.getDescription()#</textarea>
