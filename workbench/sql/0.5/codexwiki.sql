...
# Server OS:            apple-darwin8.5.1
# jHeidi Version:       Alpha
# --------------------------------------------------------
...
#
# Creating table structure for 'wiki_category'
#
...
#
# Creating table structure for 'wiki_customhtml'
#
...
ALTER TABLE `wiki_customhtml` DISABLE KEYS;
...
ALTER TABLE `wiki_customhtml` ENABLE KEYS;
UNLOCK TABLES;

#
# Creating table structure for 'wiki_namespace'
#
...
ALTER TABLE `wiki_namespace` DISABLE KEYS;
...
ALTER TABLE `wiki_namespace` ENABLE KEYS;
UNLOCK TABLES;

#
# Creating table structure for 'wiki_options'
#
...
ALTER TABLE `wiki_options` DISABLE KEYS;
...
ALTER TABLE `wiki_options` ENABLE KEYS;
UNLOCK TABLES;

#
# Creating table structure for 'wiki_page'
#
...
ALTER TABLE `wiki_page` DISABLE KEYS;
INSERT INTO `wiki_page` (`page_id`,`page_name`,`FKnamespace_id`) VALUES
      ('06AF3D6A-0AB3-43E6-EF2D1118F58A1562','Special:Feeds',null),
      ('58F2F999-FC99-125A-DB21FCD7085C44A1','Help:Contents',null),
      ('59014C5F-C1C6-7E91-A38446214A380C7D','Help:Wiki_Markup',null),
      ('59104F5A-9555-E540-6BCAA65D9AE6F448','Help:List_Markup',null),
      ('A8736248-DCE2-A123-A6DA083754C59203','Help:Cheatsheet',null),
      ('A895949D-B7C5-34B5-0E32B0CE52BC3FA0','Help:Messagebox_Markup',null),
      ('B3C65F8E-F2E1-954C-0A3BFBBCFF38D015','Help:WikiPlugins',null),
      ('C90869A2-090D-50DA-0800C94BB5DB7026','Help:Feed_Markup',null),
      ('E12403BB-F4C1-5F8A-1B20DB3894BAF144','Dashboard',null),
      ('E5CC1A90-D36E-9214-33EB0021D817DE59','Special:Categories',null);
ALTER TABLE `wiki_page` ENABLE KEYS;
UNLOCK TABLES;

#
# Creating table structure for 'wiki_pagecontent'
#
...
ALTER TABLE `wiki_pagecontent` DISABLE KEYS;
INSERT INTO `wiki_pagecontent` (`pagecontent_id`,`FKpage_id`,`FKuser_id`,`pagecontent_content`,`pagecontent_comment`,`pagecontent_version`,`pagecontent_createdate`,`pagecontent_isActive`,`pagecontent_isReadOnly`) VALUES
      ('06AF3D9F-F000-34AC-65CBF528D2F4F658',null,null,'== Codex RSS Feed Directory ==
<feed url="/feed/directory/list.cfm" />',null,1,'2008-02-11 15:09:50.0',null,null),
      ('5906B62D-FBD0-6F75-B6B7BF36DCD904C5',null,null,'==Wiki markup==
...
This page is covered by [http://en.wikipedia.org/wiki/Wikipedia:Text_of_the_GNU_Free_Documentation_License GNU Free Documentation License]',null,1,'2008-02-27 14:54:14.0',null,null),
      ('59121859-EB3F-023C-703B2FFFF21FBAE3',null,null,'== List basics ==
...
This page is covered under [http://en.wikipedia.org/wiki/Wikipedia:Text_of_the_GNU_Free_Documentation_License GNU Free Documentation License]',null,1,'2008-02-27 15:06:40.0',null,null),
      ('A873628C-0187-145E-574309C8195CA646',null,null,'<div align="center">
...
|}
</div>','First Import',1,'2008-11-16 19:16:53.0',null,null),
      ('A89594E7-970D-BE3D-C32A3395AD685354',null,null,'== Messagebox Markup ==
...
','First Import',1,'2008-11-16 19:54:14.0',null,null),
      ('B3B7F9E4-CFAA-241F-70B3F5069A6F4EA3',null,null,'== Help Contents ==
...
More information can be found via the Wikipedia site [http://en.wikipedia.org/wiki/Help:Contents Wikipedia Help] as this wiki follows many of its markup guidelines.','Wiki Plugins',2,'2008-11-18 23:47:37.0',null,null),
      ('B3F2E1AA-9DBE-9937-68DC4B440F0A9AEB',null,null,'= Welcome To Codex =
...
== Wiki Plugins ==
You can use wiki plugins very easily by just using their names as tags and attributes as arguments to the plugin\'s \'\'\'renderIt()\'\'\' method.

{{{WikiPlugins}}}
','Updates',5,'2008-11-19 00:51:56.0',null,null),
      ('B3FA4196-B6FF-5836-9A61F99F9E03C616',null,null,'= Codex Wiki Plugins =
...
That\'s it. Welcome to the world of Codex Wiki Plugins.  Now go out and start coding your very own plugins.
','Source Updates',3,'2008-11-19 01:00:01.0',null,null),
      ('C90869BF-F321-E64A-26D668F8EE8988B5',null,null,'== Feed Markup ==
...
|-
|}','Initial creation',1,'2008-03-20 08:53:34.0',null,null),
      ('E5CC1AC5-C484-565C-19E5F34B3712AD02',null,null,'== Category Listing ==

<feed url="/feed/category/list.cfm" display="numbered" />','Initial Creation',1,'2008-05-14 14:59:28.0',null,null);
ALTER TABLE `wiki_pagecontent` ENABLE KEYS;
UNLOCK TABLES;

#
# Creating table structure for 'wiki_pagecontent_category'
#
...
#
# Creating table structure for 'wiki_permissions'
#
...
ALTER TABLE `wiki_permissions` DISABLE KEYS;
...
ALTER TABLE `wiki_permissions` ENABLE KEYS;
UNLOCK TABLES;

#
# Creating table structure for 'wiki_role_permissions'
#
...
ALTER TABLE `wiki_role_permissions` DISABLE KEYS;
INSERT INTO `wiki_role_permissions` (`FKpermission_id`,`FKrole_id`) VALUES
      ...
      (null,null),
      (null,null);
ALTER TABLE `wiki_role_permissions` ENABLE KEYS;
UNLOCK TABLES;

#
# Creating table structure for 'wiki_roles'
#
...
ALTER TABLE `wiki_roles` DISABLE KEYS;
...
ALTER TABLE `wiki_roles` ENABLE KEYS;
UNLOCK TABLES;

#
# Creating table structure for 'wiki_securityrules'
#
...
ALTER TABLE `wiki_securityrules` DISABLE KEYS;
...
ALTER TABLE `wiki_securityrules` ENABLE KEYS;
UNLOCK TABLES;

#
# Creating table structure for 'wiki_users'
#
...
ALTER TABLE `wiki_users` DISABLE KEYS;
INSERT INTO `wiki_users` (`user_id`,`user_fname`,`user_lname`,`user_email`,`user_isActive`,`user_isConfirmed`,`user_create_date`,`user_modify_date`,`user_isDefault`,`user_username`,`user_password`,`FKrole_id`) VALUES
      ('A9CF56CA-CF1E-5C1B-91F2AEF8FBD03AA4','ANONYMOUS','ANONYMOUS','ANONYMOUS@CODEXWIKI.COM',null,null,'2008-03-18 15:12:22.0','0100-01-01 00:00:00.0',null,'ANONYMOUS','A2AD7D448321F4D974D468E0B251030E5BED9F128BC760FA3DBA299756E9B31A4D6F8504EA4F10DC2665834E5FFA93CB978FD2FD075C53322C58CD6FE7A7A878',null),
      ('A9D7F9E5-CF1E-5C1B-935B04502EB6B9A1','admin','admin','admin@codexwiki.com',null,null,'2008-06-18 08:25:35.0','2008-05-22 23:57:52.0',null,'admin','0CD487D652F3139D5E01E3263B3B37995602EB8692D11BB37E4DBE33F40581852C63A9964EBC233E10BEB192B2851AA613E640E5137132CA8C061D3327388E5F',null);
ALTER TABLE `wiki_users` ENABLE KEYS;
UNLOCK TABLES;

#
# Creating table structure for 'wiki_users_permissions'
#
