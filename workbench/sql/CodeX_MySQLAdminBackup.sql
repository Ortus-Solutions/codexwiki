...
CREATE TABLE `wiki_namespace` (
  ...
  `namespace_isdefault` bit(1) NOT NULL default '\0',
...
INSERT INTO `wiki_namespace` (`namespace_id`,`namespace_name`,`namespace_description`,`namespace_isdefault`) VALUES 
 ('06AF3D1C-0B00-EAA3-09A138DFA27F7E28','Special','Special',0x00),
 ('58F2F981-F62A-3124-E886BBF8CE6C5295','Help','Help',0x00),
 ('F1C0292E-CB06-FD09-41D904E8550FE734','','Default Namespace',0x01);
...
CREATE TABLE `wiki_pagecontent` (
  ...
  `pagecontent_isActive` bit(1) NOT NULL default '',
...
INSERT INTO `wiki_permissions` (`permission_id`,`permission`) VALUES 
 ('883FFD91-CD95-918B-C7018413DCAF5606','ADMIN_TAB'),
...
INSERT INTO `wiki_securityrules` (`securityrule_id`,`whitelist`,`securelist`,`roles`,`redirect`) VALUES 
...
CREATE TABLE `wiki_users` (
  ...
  `user_isActive` bit(1) NOT NULL default '',
  `user_isConfirmed` bit(1) NOT NULL default '\0',
  ...
  `user_isDefault` bit(1) NOT NULL default '\0',
...
CREATE TABLE `wiki_users_permissions` (
  ...
  UNIQUE KEY `FKuser_id` (`FKuser_id`),
  KEY `FKpermission_id` (`FKpermission_id`),
  KEY `FKuser_id_2` (`FKuser_id`),
  KEY `FKpermission_id_2` (`FKpermission_id`),
  KEY `FKuser_id_3` (`FKuser_id`),
